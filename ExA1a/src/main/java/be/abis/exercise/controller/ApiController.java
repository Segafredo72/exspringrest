...
public class ApiController {
	...
	public void changePasswordById(@PathVariable("id") int id, @RequestBody Password password) throws IOException {
		personService.changePassword(personService.findPerson(id), password.getPassword());
	}
